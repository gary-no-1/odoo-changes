...
--
-- Name: view_cjpl_CRM; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW "view_cjpl_CRM" AS
 SELECT DISTINCT m.id,
    m.code AS lead_id,
    date(m.create_date) AS create_date,
    date(m.date_open) AS open_date,
    date(m.date_last_stage_update) AS last_stage_update,
    date(m.message_last_post) AS message_post,
    date(m.date_action_next) AS next_action_date,
    date(m.write_date) AS write_date,
    m.partner_id,
    m.partner_name,
    m.planned_revenue,
    m.ref AS sale_order,
    m.name AS product_type,
    m.probability,
    n.name AS stage_name,
    m.type AS opportunity
   FROM (crm_lead m
     JOIN crm_case_stage n ON ((m.stage_id = n.id)))
  ORDER BY m.code;


ALTER TABLE public."view_cjpl_CRM" OWNER TO postgres;
...
--
-- Name: view_cjpl_invoice_line_base_tax; Type: VIEW; Schema: public; Owner: odoo
--

CREATE VIEW view_cjpl_invoice_line_base_tax AS
...
ALTER TABLE public.view_cjpl_invoice_line_base_tax OWNER TO odoo;
...
--
-- Name: view_cjpl_xxx_invoice_list_all; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW view_cjpl_xxx_invoice_list_all AS
...
ALTER TABLE public.view_cjpl_xxx_invoice_list_all OWNER TO postgres;

--
-- Name: view_cjpl_invoice_list_final; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW view_cjpl_invoice_list_final AS
 SELECT b.invoice_id,
    a.so_number,
    a.date_order,
    b.core_code,
...
ALTER TABLE public.view_cjpl_invoice_list_final OWNER TO postgres;
...
--
-- Name: view_cjpl_team_name; Type: VIEW; Schema: public; Owner: odoo
--

CREATE VIEW view_cjpl_team_name AS
...
ALTER TABLE public.view_cjpl_team_name OWNER TO odoo;
...
--
-- Name: view_cjpl_xxx_invoice_for_tally_1; Type: VIEW; Schema: public; Owner: odoo
--

CREATE VIEW view_cjpl_xxx_invoice_for_tally_1 AS
 SELECT a.id,
    a.number,
    a.date_invoice,
    b.company_name,
...
ALTER TABLE public.view_cjpl_xxx_invoice_for_tally_1 OWNER TO odoo;

--
-- Name: view_cjpl_xxx_invoice_for_tally_2; Type: VIEW; Schema: public; Owner: odoo
--

CREATE VIEW view_cjpl_xxx_invoice_for_tally_2 AS
 SELECT t.invoice_id,
    max((
        CASE
...
ALTER TABLE public.view_cjpl_xxx_invoice_for_tally_2 OWNER TO odoo;

--
-- Name: view_cjpl_xxx_invoice_for_tally_3; Type: VIEW; Schema: public; Owner: odoo
--

CREATE VIEW view_cjpl_xxx_invoice_for_tally_3 AS
 SELECT a.id,
    a.number,
    a.date_invoice,
    a.company_name,
...
ALTER TABLE public.view_cjpl_xxx_invoice_for_tally_3 OWNER TO odoo;
...
--
-- Name: view_cjpl_CRM; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE "view_cjpl_CRM" FROM PUBLIC;
REVOKE ALL ON TABLE "view_cjpl_CRM" FROM postgres;
GRANT ALL ON TABLE "view_cjpl_CRM" TO postgres;
GRANT SELECT ON TABLE "view_cjpl_CRM" TO joomla;
...
--
-- Name: view_cjpl_invoice_line_base_tax; Type: ACL; Schema: public; Owner: odoo
--

REVOKE ALL ON TABLE view_cjpl_invoice_line_base_tax FROM PUBLIC;
REVOKE ALL ON TABLE view_cjpl_invoice_line_base_tax FROM odoo;
GRANT ALL ON TABLE view_cjpl_invoice_line_base_tax TO odoo;
GRANT SELECT ON TABLE view_cjpl_invoice_line_base_tax TO joomla;
...
--
-- Name: view_cjpl_xxx_invoice_list_all; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE view_cjpl_xxx_invoice_list_all FROM PUBLIC;
REVOKE ALL ON TABLE view_cjpl_xxx_invoice_list_all FROM postgres;
GRANT ALL ON TABLE view_cjpl_xxx_invoice_list_all TO postgres;
GRANT SELECT ON TABLE view_cjpl_xxx_invoice_list_all TO joomla;


--
-- Name: view_cjpl_invoice_list_final; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE view_cjpl_invoice_list_final FROM PUBLIC;
REVOKE ALL ON TABLE view_cjpl_invoice_list_final FROM postgres;
GRANT ALL ON TABLE view_cjpl_invoice_list_final TO postgres;
GRANT SELECT ON TABLE view_cjpl_invoice_list_final TO joomla;
...
--
-- Name: view_cjpl_team_name; Type: ACL; Schema: public; Owner: odoo
--

REVOKE ALL ON TABLE view_cjpl_team_name FROM PUBLIC;
REVOKE ALL ON TABLE view_cjpl_team_name FROM odoo;
GRANT ALL ON TABLE view_cjpl_team_name TO odoo;
GRANT SELECT ON TABLE view_cjpl_team_name TO joomla;
