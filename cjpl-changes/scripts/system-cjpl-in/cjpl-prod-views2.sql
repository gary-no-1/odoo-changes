...
-- ------------------------------------------------------------
CREATE OR REPLACE VIEW view_cjpl_CRM AS 
 SELECT DISTINCT m.id,
  ...
  ORDER BY m.code;
 ALTER TABLE view_cjpl_CRM OWNER TO postgres;
 GRANT ALL ON view_cjpl_CRM TO postgres;
 GRANT SELECT ON view_cjpl_CRM TO joomla;
