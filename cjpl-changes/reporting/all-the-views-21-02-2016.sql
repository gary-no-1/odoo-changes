-- View: "odoo-views".view_cjpl_contract_to_invoice_sale_type

-- DROP VIEW "odoo-views".view_cjpl_contract_to_invoice_sale_type;
...
ALTER TABLE "odoo-views".view_cjpl_contract_to_invoice_sale_type
  OWNER TO postgres;

  
-- View: "odoo-views".view_cjpl_contract_to_invoice_sale_type2

-- DROP VIEW "odoo-views".view_cjpl_contract_to_invoice_sale_type2;
...
ALTER TABLE "odoo-views".view_cjpl_contract_to_invoice_sale_type2
  OWNER TO odoo;

  
-- View: "odoo-views".view_cjpl_invoice_list

-- DROP VIEW "odoo-views".view_cjpl_invoice_list;
...
ALTER TABLE "odoo-views".view_cjpl_invoice_list
  OWNER TO postgres;

  
-- View: "odoo-views".view_cjpl_invoice_sale_type

-- DROP VIEW "odoo-views".view_cjpl_invoice_sale_type;
...
ALTER TABLE "odoo-views".view_cjpl_invoice_sale_type
  OWNER TO postgres;


-- View: "odoo-views".view_cjpl_invoice_sale_type2

-- DROP VIEW "odoo-views".view_cjpl_invoice_sale_type2;

CREATE OR REPLACE VIEW "odoo-views".view_cjpl_invoice_sale_type2 AS 
 SELECT a.date_order,
    a.so_number,
    a.so_id,
    a.invoice_number,
    ...
    a.sale_type,
    a.invoice_type
   FROM "odoo-views".view_cjpl_order_to_invoice_sale_type2 a
UNION ALL
 SELECT b.date_order,
    b.so_number,
    b.so_id,
    ...
    b.sale_type,
    b.invoice_type
   FROM "odoo-views".view_cjpl_contract_to_invoice_sale_type2 b;

ALTER TABLE "odoo-views".view_cjpl_invoice_sale_type2
  OWNER TO postgres;

  
-- View: "odoo-views".view_cjpl_opportunity

-- DROP VIEW "odoo-views".view_cjpl_opportunity;
...
ALTER TABLE "odoo-views".view_cjpl_opportunity
  OWNER TO postgres;

-- View: "odoo-views".view_cjpl_opportunity_sale_order

-- DROP VIEW "odoo-views".view_cjpl_opportunity_sale_order;
...
ALTER TABLE "odoo-views".view_cjpl_opportunity_sale_order
  OWNER TO postgres;

 
-- View: "odoo-views".view_cjpl_order_basic

-- DROP VIEW "odoo-views".view_cjpl_order_basic;
...
ALTER TABLE "odoo-views".view_cjpl_order_basic
  OWNER TO postgres;
  
-- View: "odoo-views".view_cjpl_order_to_invoice_sale_type

-- DROP VIEW "odoo-views".view_cjpl_order_to_invoice_sale_type;
...
ALTER TABLE "odoo-views".view_cjpl_order_to_invoice_sale_type
  OWNER TO postgres;

  
 -- View: "odoo-views".view_cjpl_order_to_invoice_sale_type2

-- DROP VIEW "odoo-views".view_cjpl_order_to_invoice_sale_type2;
...
ALTER TABLE "odoo-views".view_cjpl_order_to_invoice_sale_type2
  OWNER TO odoo;


-- View: "odoo-views".view_cjpl_user_name

-- DROP VIEW "odoo-views".view_cjpl_user_name;
...
ALTER TABLE "odoo-views".view_cjpl_user_name
  OWNER TO postgres;
