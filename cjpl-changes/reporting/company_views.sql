-- View: view_cjpl_xxx_partner_is_a_company

-- DROP VIEW view_cjpl_xxx_partner_is_a_company;
...
ALTER TABLE view_cjpl_xxx_partner_is_a_company
  OWNER TO odoo;
...
-- View: view_cjpl_xxx_partner_is_not_company_but_has_parent

-- DROP VIEW view_cjpl_xxx_partner_is_not_company_but_has_parent;
...
ALTER TABLE view_cjpl_xxx_partner_is_not_company_but_has_parent
  OWNER TO odoo;
...
-- View: view_cjpl_xxx_partner_is_not_company_with_no_parent

-- DROP VIEW view_cjpl_xxx_partner_is_not_company_with_no_parent;
...
ALTER TABLE view_cjpl_xxx_partner_is_not_company_with_no_parent
  OWNER TO odoo;
